...
*/
const lowCaseAnimalNames = zooAnimals.map(word => word.animal_name.toLowerCase());
...
*/
let allPopulations = zooAnimals.map(obj => obj.population);
const populationTotal = allPopulations.reduce((total, added) => total + added);
